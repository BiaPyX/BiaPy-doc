...
This training setup uses the **Google Drive sample dataset** (``oocyte_training.zip``) as training data and the **Zenodo ovary volumes** (``raw_ovary.rar``) as the test set.
   ...
   .. tab:: GUI
      ...
      .. carousel::
        ...
        .. figure:: ../../img/tutorials/instance-segmentation/ovarian-reserve/GUI-modify-configuration-file-train.png
            ...
            Step 3: Introduce the paths to your training raw and label data from ``oocyte_training/`` (Google Drive sample dataset), set the test path to ``raw_ovary/`` (Zenodo), and type a name for your modified configuration file (red boxes indicate missing information).
