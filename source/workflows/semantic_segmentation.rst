...
.. tabs::
   ...
   .. tab:: GUI
        ...
        In the BiaPy GUI, click on the *Wizard*, then follow the next instructions to select the semantic segmentation workflow:
        ...
        .. carousel::
          ...
          .. figure:: ../img/gui/GUI-select-semantic-segmentation.png

              Step 3: Under Question 2, select the answer "Generate masks for each object in the image".
